...
async function seedUsers() {
    ...
    const insertedUsers = await db_1.db.insert(db_1.users).values(userData).returning();
 ...
 * Seed doctors
 */
async function seedDoctors(usersList) {
    ...
    const insertedDoctors = await db_1.db.insert(db_1.doctors).values(doctorData).returning();
 ...
 * Seed appointments
 */
async function seedAppointments(usersList, doctorsList) {
    ...
    const insertedAppointments = await db_1.db.insert(db_1.appointments).values(appointmentData).returning();
 ...
 * Seed prescriptions
 */
async function seedPrescriptions(appointmentsList, doctorsList, usersList) {
    ...
    const insertedPrescriptions = await db_1.db.insert(db_1.prescriptions).values(prescriptionData).returning();
 ...
 * Seed payments
 */
async function seedPayments(appointmentsList) {
    ...
    const insertedPayments = await db_1.db.insert(db_1.payments).values(paymentData).returning();
 ...
 */
async function seedComplaints(usersList, appointmentsList) {
    ...
    const insertedComplaints = await db_1.db.insert(db_1.complaints).values(complaintData).returning();
...
async function clearDatabase() {
    ...
    await db_1.db.delete(db_1.complaints);
    await db_1.db.delete(db_1.payments);
    await db_1.db.delete(db_1.prescriptions);
    await db_1.db.delete(db_1.appointments);
    await db_1.db.delete(db_1.doctors);
